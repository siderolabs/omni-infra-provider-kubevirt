...
replace github.com/siderolabs/omni/client => github.com/unix4ever/omni/client v0.0.0-20250620152828-22c12fe75b51
...
require (
	...
	github.com/siderolabs/talos/pkg/machinery v1.11.0-alpha.1 // indirect
